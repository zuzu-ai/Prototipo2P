...
public class infmr_Ventana8 extends javax.swing.JInternalFrame {

    /**
     * Creates new form infmr_Ventana1
     */
    public infmr_Ventana8() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Gestor de Marcas 9959185335");
        setToolTipText("");
        setVisible(true);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                txtNombre_A.setText(rs.getString("nombre_marca"));
                txtStatus.setText(rs.getString("estatus_marca"));
